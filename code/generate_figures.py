...
# Ensure the relative output directory exists (was '/mnt/user-data/outputs/'
# in V2 — that path is sandbox-only and won't exist on a normal machine).
...
fig1.tight_layout()
fig1.savefig('figures/fig1_chain_structure.pdf')
fig1.savefig('figures/fig1_chain_structure.png')
print("  saved fig1")
...
fig2.tight_layout()
fig2.savefig('figures/fig2_eigenstates.pdf')
fig2.savefig('figures/fig2_eigenstates.png')
print("  saved fig2")
...
fig3.tight_layout()
fig3.savefig('figures/fig3_ipr_vs_lambda.pdf')
fig3.savefig('figures/fig3_ipr_vs_lambda.png')
print("  saved fig3")
...
fig4.tight_layout()
fig4.savefig('figures/fig4_ipr_ratio.pdf')
fig4.savefig('figures/fig4_ipr_ratio.png')
print("  saved fig4")
...
fig5.tight_layout()
fig5.savefig('figures/fig5_substitution_tree.pdf')
fig5.savefig('figures/fig5_substitution_tree.png')
print("  saved fig5")
